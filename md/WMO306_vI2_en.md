...
> ![](../md/extracted-media/media/image9.png){width="0.7395833333333334in" height="0.15416666666666667in"}
>
...
|        | code table                                               |                                                                                                                                     |                            |                                                                                                                                                        |
+--------+----------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------+----------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------+
| 2017   | \(i) General provisions\                                 | \(i) Alignment with the new structure of the *Technical Regulations* (WMO-No. 49);                                                  | \(i) ---;                  | \(i) Resolution 20 (EC-69);                                                                                                                            |
|        | (pp. ix--xi);                                            |                                                                                                                                     |                            |                                                                                                                                                        |
...
\(2) *Spot wind*: For the purpose of upper-air reports from aircraft, the wind velocity, observed or predicted, for a specified location, height and time.
...
> R~n1~, R~n2~, R~n3~, . . . R~ns~
>
> where R~ij~ is the j^th^ value of the i^th^ data subset, s is the number of values per data subset, and n is the number of data subsets in the BUFR message; the data subsets each occupy an identical number of bits, unless delayed replication is used, and are *not* necessarily aligned on octet boundaries.
...
**[*Editorial note*: click following links to respective components in separate files.]{.underline}**

  [**BUFR Table A**](WMO306_vI2_BUFR_TableA_en.docx)   [**BUFR/CREX Table B**](WMO306_vI2_BUFRCREX_TableB_en.docx)        [**BUFR Table C**](WMO306_vI2_BUFR_TableC_en.docx)
  ---------------------------------------------------- ------------------------------------------------------------------ ----------------------------------------------------
  [**BUFR Table D**](WMO306_vI2_BUFR_TableD_en.docx)   [**Code and Flag tables**](WMO306_vI2_BUFRCREX_CodeFlag_en.docx)   [Attachment](WMO306_vI2_BUFR_att_en.pdf)
...
**[*Editorial note*: click following links to respective components in separate files.]{.underline}**
  ...
  [**CREX Table A**](WMO306_vI2_CREX_TableA_en.docx)   [**CREX Table B**](WMO306_vI2_CREX_ClassOfElements_en.docx)   [**CREX Table C**](WMO306_vI2_CREX_TableC_en.docx)
  ---------------------------------------------------- ------------------------------------------------------------- ----------------------------------------------------
  [**CREX Table D**](WMO306_vI2_CREX_TableD_en.docx)   [**Attachment**](WMO306_vI2_CREX_att_en.docx)                 

**c. COMMON CODE TABLES TO BINARY AND ALPHANUMERIC CODES**

***Editorial note*: click following links to respective Common Code table in a separate file.**

**[COMMON CODE TABLE C--0](WMO306_vI2_CommonTable_en.pdf): *GRIB, BUFR and CREX master table version number***
...
**[COMMON CODE TABLE C--1](WMO306_vI2_CommonTable_en.pdf): *Identification of originating/generating centre***
...
**[COMMON CODE TABLE C--2](WMO306_vI2_CommonTable_en.pdf): *Radiosonde/sounding system used***
...
**[COMMON CODE TABLE C--3](WMO306_vI2_CommonTable_en.pdf): *Instrument make and type for water temperature profile***

***measurement with fall rate equation coefficients***
...
**[COMMON CODE TABLE C--4](WMO306_vI2_CommonTable_en.pdf): *Water temperature profile recorder types***
...
**[COMMON CODE TABLE C--5](WMO306_vI2_CommonTable_en.pdf): *Satellite identifier***
...
**[COMMON CODE TABLE C--6](WMO306_vI2_CommonTable_en.pdf): *List of units for TDCFs***

**[COMMON CODE TABLE C--7](WMO306_vI2_CommonTable_en.pdf): *Tracking technique/status of system used***

> Code table 3872 -- s~a~s~a~ for alphanumeric codes
>
> Code table 0 02 014 in BUFR

**[COMMON CODE TABLE C--8](WMO306_vI2_CommonTable_en.pdf): *Satellite instruments***

> Code table 0 02 019 in BUFR

**[COMMON CODE TABLE C--11](WMO306_vI2_CommonTable_en.pdf): *Originating/generating centres***
...
**[COMMON CODE TABLE C--12](WMO306_vI2_CommonTable_en.pdf): *Sub-centres of originating centres defined by entries in Common Code tables C--1 or C--11***
...
**[COMMON CODE TABLE C--13](WMO306_vI2_CommonTable_en.pdf): *Data sub-categories of categories defined by entries in BUFR Table A***
...
**[COMMON CODE TABLE C--14](WMO306_vI2_CommonTable_en.pdf): *Atmospheric chemical or physical constituent type***
...
**[B/C1](WMO306_vI2_BUFRCREX_BC1_en.pdf) -- Regulations for reporting SYNOP data in TDCF**

**Annex: Regional regulations for reporting SYNOP data in BUFR/CREX for RA I, RA II, RA III, RA IV and RA VI**

**[B/C5](WMO306_vI2_BUFRCREX_BC5_en.pdf) -- Regulations for reporting SYNOP MOBIL data in TDCF**

**[B/C10](WMO306_vI2_BUFRCREX_BC10_en.pdf) -- Regulations for reporting SHIP data in TDCF**

**[B/C20](WMO306_vI2_BUFRCREX_BC20_en.pdf) -- Regulations for reporting PILOT, PILOT SHIP and PILOT MOBIL data in TDCF**

**[B/C25](WMO306_vI2_BUFRCREX_BC25_en.pdf) -- Regulations for reporting TEMP, TEMP SHIP and TEMP MOBIL data in TDCF**

**Annex I: RA IV BUFR template for TEMP, TEMP SHIP and TEMP MOBIL data**

**Annex II: List of parameters for representation of additional information on sounding instrumentation**

**[B/C26](WMO306_vI2_BUFRCREX_BC26_en.pdf) -- Regulations for reporting TEMP DROP data in TDCF**

**[B/C30](WMO306_vI2_BUFRCREX_BC30_en.pdf) -- Regulations for reporting CLIMAT data in TDCF**

**[B/C32](WMO306_vI2_BUFRCREX_BC32_en.pdf) -- Regulations for reporting CLIMAT SHIP data in TDCF**
...
***Editorial note*: click following link to respective attachment in a separate file.**

[**LIST OF ALPHANUMERIC CODE TABLES RELATED TO\
BUFR AND CREX CODE TABLES AND FLAG TABLES**](WMO306_vI2_PartC_att2_en.pdf)
...
Email[: cpa\@wmo.int](mailto::%20cpa@wmo.int)
