...
\textbf{400--499: Numbers allocated to India}
...
\textbf{700--799: Numbers allocated to the United States}
...
& \textbf{Base SI units (1)} & & & &\tabularnewline
001 & metre & m & m & M &\tabularnewline
002 & kilogram & kg & kg & KG &\tabularnewline
003 & second & s & s & S &\tabularnewline
004 & ampere & A & A & A &\tabularnewline
005 & kelvin & K & K & K &\tabularnewline
006 & mole & mol & mol & MOL &\tabularnewline
007 & candela & cd & cd & CD &\tabularnewline
& \textbf{Supplementary SI Units (1)} & & & &\tabularnewline
021 & radian & rad & rad & RAD &\tabularnewline
022 & steradian & sr & sr & SR &\tabularnewline
& \textbf{Derived SI Units with special names (1)} & & & &\tabularnewline
030 & hertz & Hz & Hz & HZ & s\textsuperscript{--1}\tabularnewline
031 & newton & N & N & N & kg m s\textsuperscript{--2}\tabularnewline
032 & pascal & Pa & Pa & PAL & kg m\textsuperscript{--1} s\textsuperscript{--2}\tabularnewline
033 & joule & J & J & J & kg m\textsuperscript{2} s\textsuperscript{--2}\tabularnewline
034 & watt & W & W & W & kg m\textsuperscript{2} s\textsuperscript{--3}\tabularnewline
035 & coulomb & C & C & C & A s\tabularnewline
036 & volt & V & V & V & kg m\textsuperscript{2} s\textsuperscript{--3} A\textsuperscript{--1}\tabularnewline
037 & farad & F & F & F & kg\textsuperscript{--1} m\textsuperscript{--2} s\textsuperscript{4} A\textsuperscript{2}\tabularnewline
038 & ohm & Ω & Ohm & OHM & kg m\textsuperscript{2} s\textsuperscript{--3} A\textsuperscript{--2}\tabularnewline
039 & siemens & S & S & SIE & kg\textsuperscript{--1} m\textsuperscript{--2} s\textsuperscript{3} A\textsuperscript{2}\tabularnewline
040 & weber & Wb & Wb & WB & kg m\textsuperscript{2} s\textsuperscript{--2} A\textsuperscript{--1}\tabularnewline
041 & tesla & T & T & T & kg s\textsuperscript{--2} A\textsuperscript{--1}\tabularnewline
042 & henry & H & H & H & kg m\textsuperscript{2} s\textsuperscript{--2} A\textsuperscript{--2}\tabularnewline
060 & degree Celsius & °C & Cel & CEL & K+273.15\tabularnewline
070 & lumen & lm & lm & LM & cd sr\tabularnewline
071 & lux & lx & lx & LX & cd sr m\textsuperscript{--2}\tabularnewline
080 & becquerel & Bq & Bq & BQ & s\textsuperscript{--1}\tabularnewline
081 & grey & Gy & Gy & GY & m\textsuperscript{2} s\textsuperscript{--2}\tabularnewline
082 & sievert & Sv & Sv & SV & m\textsuperscript{2} s\textsuperscript{--2}\tabularnewline
& \textbf{SI Unit prefixes (1) (3) (4)} & & & &\tabularnewline
no & (yotta) & (Y) & (Y) & (Y) &\tabularnewline
no & (zetta) & (Z) & (Z) & (Z) &\tabularnewline
no & exa & E & E & E &\tabularnewline
no & peta & P & P & PE &\tabularnewline
no & tera & T & T & T &\tabularnewline
no & giga & G & G & G &\tabularnewline
no & mega & M & M & MA &\tabularnewline
no & kilo & k & k & K &\tabularnewline
no & hecto & h & h & H &\tabularnewline
no & deca & da & da & DA &\tabularnewline
no & deci & d & d & D &\tabularnewline
no & centi & c & c & C &\tabularnewline
no & milli & m & m & M &\tabularnewline
no & micro & μ & u & U &\tabularnewline
\textbf{Code figure} & & \textbf{Conventional abbreviation} & \textbf{Abbreviation in IA5/ASCII (5)} & \textbf{Abbreviation\\
in ITA2 (5)} & \textbf{Definition in\\
base units (2)}\tabularnewline
no & nano & n & n & N &\tabularnewline
no & pico & p & p & P &\tabularnewline
no & femto & f & f & F &\tabularnewline
no & atto & a & a & A &\tabularnewline
no & (zepto) & (z) & (z) & &\tabularnewline
no & (yocto) & (y) & (y) & &\tabularnewline
& \textbf{Other, non-SI, units recognized by CGPM (4)} & & & &\tabularnewline
110 & degree (angle) & ° & deg & DEG &\tabularnewline
111 & minute (angle) & ' & ' & MNT &\tabularnewline
112 & second (angle) & " & " & SEC &\tabularnewline
120 & litre & l or L & l or L & L &\tabularnewline
130 & minute (time) & min & min & MIN &\tabularnewline
131 & hour & h & h & HR &\tabularnewline
132 & day & d & d & D &\tabularnewline
150 & tonne & t & t & TNE &\tabularnewline
160 & electron volt & eV & eV & EV &\tabularnewline
161 & atomic mass unit & u & u & U &\tabularnewline
170 & astronomic unit & AU & AU & ASU &\tabularnewline
171 & parsec & pc & pc & PRS &\tabularnewline
& \textbf{Non-SI Units tolerated because of widespread use} & & & &\tabularnewline
...
in ITA2 (5)} & \textbf{Definition in\\
base units (2)}\tabularnewline
776 & kilograms per square metre per second & kg m\textsuperscript{--2} s\textsuperscript{--1} & kg m--2 s--1 & &\tabularnewline
777 & kilograms per cubic metre & kg m\textsuperscript{--3} & kg m--3 & &\tabularnewline
778 & per square kilogram per second & kg\textsuperscript{--2} s\textsuperscript{--1} & kg--2 s--1 & &\tabularnewline
779 & seconds per metre & s m\textsuperscript{--1} & s/m & &\tabularnewline
785 & kelvin metres per second & K m s\textsuperscript{--1} & K m s--1 & &\tabularnewline
786 & kelvins per metre & K m\textsuperscript{--1} & K/m & &\tabularnewline
787 & \vtop{\hbox{\strut kelvin square metres per kilogram}\hbox{\strut per second}} & K m\textsuperscript{2} kg\textsuperscript{--1} s\textsuperscript{--1} & K m2 kg--1 s--1 & &\tabularnewline
788 & moles per mole & mol mol\textsuperscript{--1} & mol/mol & &\tabularnewline
790 & radians per metre & rad m\textsuperscript{--1} & rad/m & &\tabularnewline
795 & newtons per square metre & N m\textsuperscript{--2} & N m--2 & &\tabularnewline
800 & pascals per second & Pa s\textsuperscript{--1} & Pa/s & &\tabularnewline
801 & kilopascal & kPa & kPa & &\tabularnewline
805 & joules per square metre & J m\textsuperscript{--2} & J m--2 & &\tabularnewline
806 & joules per kilogram & J kg\textsuperscript{--1} & J/kg & &\tabularnewline
810 & watts per metre per steradian & W m\textsuperscript{--1} sr\textsuperscript{--1} & W m--1 sr--1 & &\tabularnewline
811 & watts per square metre & W m\textsuperscript{--2} & W m--2 & &\tabularnewline
812 & watts per square metre per steradian & W m\textsuperscript{--2} sr\textsuperscript{--1} & W m--2 sr--1 & &\tabularnewline
813 & watts per square metre per steradian centimetre & W m\textsuperscript{--2} sr\textsuperscript{--1} cm & W m--2 sr--1 cm & &\tabularnewline
814 & watts per square metre per steradian metre & W m\textsuperscript{--2} sr\textsuperscript{--1} m & W m--2 sr--1 m & &\tabularnewline
815 & watts per cubic metre per steradian & W m\textsuperscript{--3} sr\textsuperscript{--1} & W m--3 sr--1 & &\tabularnewline
820 & siemens per metre & S m\textsuperscript{--1} & S/m & &\tabularnewline
825 & square degrees & degree\textsuperscript{2} & deg2 & &\tabularnewline
830 & becquerel seconds per cubic metre & Bq s m\textsuperscript{--3} & Bq s m--3 & &\tabularnewline
835 & decibels per metre & dB m\textsuperscript{--1} & dB/m & &\tabularnewline
836 & decibels per degree & dB degree\textsuperscript{--1} & dB/deg & &\tabularnewline
841 & pH unit & pH unit & pH unit & &\tabularnewline
842 & N units & N units & N units & &\tabularnewline
843 & Nephelometric turbidity units & NTU & NTU & &\tabularnewline
\bottomrule
\end{longtable}
...
\textbf{00064--00073: Centres in Region V}
...
(\emph{continued}) 7 Upper-level temperature/humidity/wind reports from
...
19 Hydrogen peroxide H\textsubscript{2}O\textsubscript{2}
...
10013 Peroxyacetyl nitrate CH\textsubscript{3}C(O)OONO\textsubscript{2}
...
60005 Total inorganic chlorine Cl\textsubscript{x}
